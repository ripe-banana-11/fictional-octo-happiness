...
async def run_champion_generation(
    ...
    (
        ...
        background_image_without_background,
    ...
    trellis_req = TrellisRequest(
        images=[left_image_without_background, right_image_without_background, background_image_without_background, original_image_without_background],
        seed=seed,
        params=params,
    )
